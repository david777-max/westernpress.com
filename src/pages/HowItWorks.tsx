...
import { FileText, Search, Send, Calendar, CheckCircle, DollarSign, ArrowRight } from 'lucide-react';
  ...
  const detailedSteps = [
    ...
    },
    {
      ...
      details: [
        ...
        'Mock interview sessions available',
        ...
        <div className="container-custom">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
              A transparent, step-by-step breakdown of how we help you land high-paying developer jobs in 15-20 days
            </p>
          </div>
        </div>
      </section>
            ...
            {detailedSteps.map((step, index) => (
              <div key={index} className="flex flex-col lg:flex-row items-center gap-12">
                ...
                <div className={`lg:w-1/2 ${index % 2 === 1 ? 'lg:order-1' : ''}`}>
                  <div className="card p-8 bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-800 dark:to-gray-700">
