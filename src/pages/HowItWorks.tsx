  ...
  const detailedSteps = [
    {
      ...
      details: [
        ...
        'Clear 80/20 income split structure',
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg border-2 border-gray-200 dark:border-gray-600">
                      ...
                      <span className="text-xl font-bold text-gray-900 dark:text-white">$12,500</span>
                    </div>
                  </div>
                </div>
                <div className="space-y-6">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 mb-4">
                      You keep 80% of your salary permanently. We earn 20%.
                    </p>
